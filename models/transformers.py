...
from components.position_encodings import 	PositionalEncoding, CosineNpiPositionalEncoding, LearnablePositionalEncoding
...
class TransformerXLModel(nn.Module):
	...
	def forward(self, src):
		output = self.transformer_encoder(transpose(0,1), mems = None)[0].transpose(0,1)
