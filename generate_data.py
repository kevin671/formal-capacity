...
from utils.logger import get_logger, print_log, store_results
from dataloader import DyckCorpus, Sampler, CounterCorpus, ShuffleCorpus, ParityCorpus, CRLCorpus, StarFreeCorpus, NonStarFreeCorpus, TomitaCorpus, BooleanExprCorpus, RDyckCorpus, CAB_n_ABDCorpus
from model import LanguageModel, build_model, train_model, run_validation
...
def main():
	...
	with open(os.path.join(data_dir, 'train_txt'), 'w') as f:
